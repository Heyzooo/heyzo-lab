...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-orange-50">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 shadow-soft max-w-md">
                <h4 className="font-bold text-lg mb-2 text-gray-800">最新情報をお届け</h4>
                ...
                <div className="flex gap-2">
                  <input
                    type="email"
                    placeholder="メールアドレス"
                    className="flex-1 px-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-orange-500"
                  />
                  <button className="px-6 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-medium hover:shadow-lg transition-all">
                    登録
                  </button>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="#services" className="text-gray-700 hover:text-orange-600 transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-gray-400 rounded-full group-hover:bg-orange-500 transition-colors"></span>
                    コンサルティングプラン
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="#cases" className="text-gray-700 hover:text-orange-600 transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-gray-400 rounded-full group-hover:bg-orange-500 transition-colors"></span>
                    成功事例
                  </Link>
                </li>
                <li>
                  <Link href="#process" className="text-gray-700 hover:text-orange-600 transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-gray-400 rounded-full group-hover:bg-orange-500 transition-colors"></span>
                    ご利用の流れ
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                <a href="mailto:hello@heyzo-lab.com" className="flex items-center gap-3 text-gray-700 hover:text-orange-600 transition-colors group">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-500 rounded-xl flex items-center justify-center hover:shadow-lg transition-all transform hover:scale-110">
